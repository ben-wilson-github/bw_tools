...
#     def setUp(self) -> None:
#         self.test_package_file_path = os.path.join(
#             os.path.dirname(__file__), "resources\\test_node.sbs"
#         )
#         self.pkg_mgr = sd.getContext().getSDApplication().getPackageMgr()
#         self.test_package = self.pkg_mgr.loadUserPackage(
#             self.test_package_file_path
#         )
